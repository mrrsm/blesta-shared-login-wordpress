=== Plugin Name ===
Contributors: mrrsm
Donate link: https://www.mrrsmtechnologies.com/donate/
Tags: login, shared login, blesta, github, user sharing, shared
...
Installing "Blesta Shared Login" can be done either by searching for "Blesta
Shared Login" via the "Plugins > Add New" screen in your WordPress dashboard,
...
If your user in wordpress doesn't match the user in Blesta it will not
properly redirect back


== Changelog ==

= 1.0 =
* Basic redirect to Blesta and back upon successful login
